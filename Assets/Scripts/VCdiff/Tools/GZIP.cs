...
namespace FileDiffTool.Tools
{
    class GZIP
    {
        ...
        /// gZip压缩文件 （单个文件）
        /// </summary>
        /// <param name="filePath">filePath为需要压缩的文件路径</param>
        /// <param name="zipFilePath">zipFilePath为压缩文件存放路径</param>
        ...
        /// </summary>
        /// <param name="zipFilePath">zipFilePath为压缩文件存放路径</param>
        /// <param name="filePath">filePath为解压后文件存放路径</param>
        public static void DecompressFile(string zipFilePath, string filePath)
        {
