...
namespace VCDiff.Encoders
{
    public class ChunkEncoder : IDisposable
    {
        ...
        /// 将数据块实际编码为 VCDiff 格式
        /// </summary>
        /// <param name="dictionary">字典哈希表</param>
        /// <param name="oldData">字典哈希表的数据</param>
        /// <param name="hash">滚动哈希对象</param>
        /// <param name="interleaved">是否交错数据</param>
        /// <param name="checksum">是否包含每个窗口的校验和</param>
