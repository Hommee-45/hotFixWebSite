...
namespace XLua.CSObjectWrap
{
    ...
    public class HotfixFrameWorkDownloadResTypeWrap
    {
		public static void __Register(RealStatePtr L)
        {
		    ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
		    Utils.BeginObjectRegister(typeof(HotfixFrameWork.DownloadResType), L, translator, 0, 0, 0, 0);
			Utils.EndObjectRegister(typeof(HotfixFrameWork.DownloadResType), L, translator, null, null, null, null, null);
			
			Utils.BeginClassRegister(typeof(HotfixFrameWork.DownloadResType), L, null, 6, 0, 0);

            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "DownloadFail", HotfixFrameWork.DownloadResType.DownloadFail);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "DownloadSuccess", HotfixFrameWork.DownloadResType.DownloadSuccess);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "Different", HotfixFrameWork.DownloadResType.Different);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "Unusual", HotfixFrameWork.DownloadResType.Unusual);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "LatestVersion", HotfixFrameWork.DownloadResType.LatestVersion);
            

			Utils.RegisterFunc(L, Utils.CLS_IDX, "__CastFrom", __CastFrom);
            
            Utils.EndClassRegister(typeof(HotfixFrameWork.DownloadResType), L, translator);
        }
        ...
        static int __CastFrom(RealStatePtr L)
		{
            ...
            if (lua_type == LuaTypes.LUA_TNUMBER)
            {
                translator.PushHotfixFrameWorkDownloadResType(L, (HotfixFrameWork.DownloadResType)LuaAPI.xlua_tointeger(L, 1));
            }
			
            else if(lua_type == LuaTypes.LUA_TSTRING)
            {

			    if (LuaAPI.xlua_is_eq_str(L, 1, "DownloadFail"))
                {
                    translator.PushHotfixFrameWorkDownloadResType(L, HotfixFrameWork.DownloadResType.DownloadFail);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "DownloadSuccess"))
                {
                    translator.PushHotfixFrameWorkDownloadResType(L, HotfixFrameWork.DownloadResType.DownloadSuccess);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "Different"))
                {
                    translator.PushHotfixFrameWorkDownloadResType(L, HotfixFrameWork.DownloadResType.Different);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "Unusual"))
                {
                    translator.PushHotfixFrameWorkDownloadResType(L, HotfixFrameWork.DownloadResType.Unusual);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "LatestVersion"))
                {
                    translator.PushHotfixFrameWorkDownloadResType(L, HotfixFrameWork.DownloadResType.LatestVersion);
                }
				else
                {
                    return LuaAPI.luaL_error(L, "invalid string for HotfixFrameWork.DownloadResType!");
                }
            ...
            {
                return LuaAPI.luaL_error(L, "invalid lua type for HotfixFrameWork.DownloadResType! Expect number or string, got + " + lua_type);
            }
